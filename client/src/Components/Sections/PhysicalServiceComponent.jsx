...
export default function Service({isDigitalSecurityActive}) {
  ...
  useEffect(() => {
    const fetchPhysicalServices = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/service/physical/first-five`);
        ...
        setServices([
          { 
            _id: 1,
            image: "https://images.unsplash.com/photo-1571900946147-97a0897ce71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80", 
            name: "Armed Security Personnel", 
            description: "Highly trained armed professionals for maximum protection." 
          },
          { 
            _id: 2,
            image: "https://images.unsplash.com/photo-1590650153855-d6d4c0f01390?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80", 
