...
export default function TestCard({ isDigitalSecurityActive }) {
  ...
  useEffect(() => {
    const fetchTestimonials = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/testimonial/get`);
        ...
        setTestimonials([
          {
            quote: "The security services provided were exceptional and gave us complete peace of mind.",
            name: "Sarah Johnson",
          ...
          {
            quote: "Professional team that delivers on their promises with outstanding results.",
            name: "Michael Chen",
            title: "Business Owner",
            avatar: "https://randomuser.me/api/portraits/men/32.jpg",
            image: "https://images.unsplash.com/photo-1573497620053-ea5300f94f21?ixlib=rb-4.0.3&auto=format&fit=crop&w=1374&q=80",
          },
          {
            quote: "Their expertise in security solutions is unmatched in the industry.",
